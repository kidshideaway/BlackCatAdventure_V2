	...
	jQuery(document).on('click', '#add_new_cat_buddon', function () {
		...
		if (newCatVal !== "") {
			...
			jQuery('.inside > ul').find('#allCategories').before(
				"<li class='hndle'><input class='del_val' value='" + newCatVal + "' style=''>" + "<span id='delete_cat' style='' value='a'><img src='" + imagesUrl + "/admin/delete1.png' width='9' height='9' value='a'>" +
				"</span><span id='edit_cat' style=''><img src='" + imagesUrl + "/admin/edit3.png' width='10' height='10'>" +
				"</span></li>");
