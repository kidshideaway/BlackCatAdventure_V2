jQuery(document).ready(function(){
            ...
            jQuery('#pfhub_portfolioinsert').on('click', function () {
                ...
                var id = jQuery('#pfhub_portfolio_portfolio-select option:selected').val();
                ...
                window.send_to_editor('[pfhub_portfolio_portfolio id="' + id + '"]');
                tb_remove();
            ...
            jQuery('#pfhub_portfolio_portfolio-select').change(function () {
