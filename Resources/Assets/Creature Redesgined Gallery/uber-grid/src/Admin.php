...
class Admin
{
    ...
    {
        $this->lightbox_settings= new AdminLightboxSettings();
        $this->general_settings = new AdminSettings();
    ...
    public function admin_scripts($hook)
    {
        ...
        if (in_array($hook, $GLOBALS['pfhub_portfolio']->admin->pages)) {
            ...
            wp_localize_script( 'pfhub_portfolio_admin_js', 'imagesUrl', PFHUB_PORTFOLIO_IMAGES_URL );
    ...
    {
        $this->pages[] = add_menu_page(__('NavyPlugins Portfolio Gallery', 'pfhub_portfolio'), __('Portfolio Gallery', 'pfhub_portfolio'), 'delete_pages', 'portfolios_pfhub_portfolio_portfolio', array(
            AdminGrids::class,
            'load_portfolio_page'
        ), 'dashicons-layout');
