        ...
        <div id="poststuff">
            <div id="portfolio-header">
                <ul id="portfolios-list">
                    ...
                    ?>
                    <li class="add-new">
                        <a onclick="window.location.href='<?php echo $add_new_portfolio_safe_link; ?>'" class="pfhub_portfolio_button" style="font-size:20px; line-height: 18px;">+</a>
                    </li>
                </ul>
            </div>
            <div id="post-body" class="metabox-holder columns-2">
                                        ...
                                        $j ++; ?>' data-portfolio-item-id="<?php echo $rowimages->id; ?>">
                                            ...
                                            <div class="image-options">
                                                ...
                                                <div class="category-container">
                                                    ...
                                                    <select class="pfhub_portfolio_input" id="multipleSelect" multiple="multiple">
                                                        <?php
                                        ...
                                        $j ++; ?>' data-portfolio-item-id="<?php echo $rowimages->id; ?>">
                                            ...
                                            <div class="image-options">
                                                <div class="options-container">
                                                    <div class="pfhub_portfolio_modern_field">
                                                        <input type="text"
                                                               placeholder="<?php echo __( 'Label', 'pfhub_portfolio' ); ?>"
                                                               id="titleimage<?php echo $rowimages->id; ?>"
                                                               name="titleimage<?php echo $rowimages->id; ?>"
                                                    ...
                                                    <div class="pfhub_portfolio_modern_field description-block">
                                                        <textarea
                                                                  ...
                                                                  placeholder="<?php echo __( 'Caption', 'pfhub_portfolio' ); ?>"
                                                                  name="im_description<?php echo $rowimages->id; ?>"><?php echo esc_html( stripslashes( $rowimages->description ) ); ?></textarea>
                                                        <label for="im_description<?php echo $rowimages->id; ?>">Caption</label>
                                                    </div>
                                                    <div class="link-block">
                                                        <div class="pfhub_portfolio_modern_field url-input">
                                                            <input type="text"
                                                                   placeholder="<?php echo __( 'URL', 'pfhub_portfolio' ); ?>"
                                                                   id="media_url<?php echo $rowimages->id; ?>"
                                                                   name="media_url<?php echo $rowimages->id; ?>"
                                                                   value="<?php echo esc_attr( $rowimages->media_url ); ?>">
                                                            <label for="media_url1">URL</label>
                                                        </div>
                ...
                <div id="postbox-container-1" class="postbox-container">
                    <div id="side-sortables" class="meta-box-sortables ui-sortable">
                        <div id="portfolio-unique-options" class="postbox">
                            ...
                            <ul id="portfolio-unique-options-list">
                                ...
                                <li class="no-content-slider no-full-width">
                                    <label
                                            for="slider_effect"><?php echo __( 'Show In Center', 'navy_grid' ); ?></label>
                                    <select name="sl_position" id="slider_effect"  style="width:103px">
                            ...
                            <div id="major-publishing-actions" class="postbox-footer">
                                <div id="publishing-action">
                                    <input type="button" onclick="pfhubPortfolioSubmitButton('apply')"
                                           ...
                                           id="save-buttom" class="pfhub_portfolio_button">
                                </div>
                                <div class="clear"></div>
                            </div>
                        </div>
                                ...
                                <ul>
                                    ...
                                    <li class="allowIsotope">
                                        ...
                                        <input type="checkbox"
                                            ...
                                            echo 'checked="checked"';
                                        } ?> name="pfhub_portfolio_show_filtering" value="on"/>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="postbox">
                            <h3 class="hndle"><span><?php echo __( 'Categories', 'pfhub_portfolio' ); ?>:</span>&nbsp;&nbsp;</h3>
                            <div class="inside">
                                <ul>
                                    <?php
