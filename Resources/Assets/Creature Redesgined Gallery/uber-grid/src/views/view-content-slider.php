						...
						switch ( \PfhubPortfolio\Helpers\GridHelper::getVideoType( $imgurl[0] ) ) {
							...
							case 'youtube':
								...
								<a href="https://www.youtube.com/embed/<?php echo $videourl[0]; ?>"
								   ...
								   class="portfolio-group<?php echo esc_attr($group_key1); ?> pfhub_portfolio_portfolio_item pyoutube portfolio-group-slider_<?php echo esc_attr($portfolioID); ?>_<?php echo esc_attr($group_key1); ?> add-H-relative add-H-block"
							...
							case 'vimeo':
								...
								?>
								<a class="portfolio-group<?php echo esc_attr($group_key1); ?> pfhub_portfolio_portfolio_item pvimeo portfolio-group-slider_<?php echo esc_attr($portfolioID); ?>_<?php echo esc_attr($group_key1); ?>   add-H-relative add-H-block"
								...
								foreach ( $imgurl as $key => $img ) {
									switch ( \PfhubPortfolio\Helpers\GridHelper::getVideoType( $img ) ) {
										...
										case 'youtube':
											...
											<li>
												<a href="https://www.youtube.com/embed/<?php echo esc_attr($videourl[0]); ?>"
                                                   data-description=" <?php echo esc_attr( $row->description ); ?>"
												   class="portfolio-group<?php echo $group_key1; ?> pfhub_portfolio_portfolio_item pyoutube portfolio-group-slider_<?php echo esc_attr($portfolioID); ?>_<?php echo esc_attr($group_key1); ?>  add-H-relative" data-groupID="<?php echo esc_attr($group_key1);?>">
										...
										case 'vimeo':
											...
											$imgsrc = $hash[0]['thumbnail_large']; ?>
											<li>
												<a class="portfolio-group<?php echo esc_attr($group_key1); ?> pfhub_portfolio_portfolio_item pvimeo portfolio-group-slider_<?php echo esc_attr($portfolioID); ?>_<?php echo esc_attr($group_key1); ?>  add-H-relative"
												   href="http://player.vimeo.com/video/<?php echo esc_attr($videourl[0]); ?> "
                                                   data-description=" <?php echo esc_attr( $row->description ); ?>"
